...
<head>
    ...
    <title>Science - iBlogs</title>
</head>

<body>

    <div class="container my-6">
        <h1 class="is-size-1 has-text-centered font-fam3 border-bottom-set color-heads mb-5 ">Science Related Blogs</h1>
    </div>
    ...
    <div class="container my-6">
        <div class="row my-6">
            ...
            if ($conn) {
                ...
                $sql = "SELECT `blog_title`, `blogger_name`, `blog_post`, `blog_category`, `date` FROM `users` WHERE `blog_category` = 'Science'";
